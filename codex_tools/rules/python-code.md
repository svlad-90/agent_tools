...
1. Use `codex_tools/tools/code_map` whenever Python code is inspected, changed,
...
Run `python -m codex_tools.tools.code_map help` for the compact command reference.
