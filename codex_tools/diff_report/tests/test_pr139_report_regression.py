...
class Pr139ReportRegressionTests(unittest.TestCase):
    ...
    def test_pr139_report_renders_current_supported_features(self) -> None:
        ...
        expected_fragments = [
            ...
            "svg .asset-search-submatch { fill: rgba(255,42,61,.16); stroke: #ff2a3d;",
            ...
            ".settings-launcher { position: fixed; left: max(8px, calc(var(--nav-width) + var(--floating-content-gutter) - var(--floating-control-size) - var(--floating-control-gap))); bottom: 24px;",
