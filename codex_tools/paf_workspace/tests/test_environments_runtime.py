...
def test_cpp_code_map_check_command_runs_optional_source_checks() -> None:
    ...
    assert "python3 -m codex_tools.tools.cpp_code_map help" in command
    assert "python3 -m codex_tools.tools.cpp_light_code_map help" in command
    assert "python3 -m codex_tools.tools.cpp_code_map doctor" in command
...
def test_cpp_code_map_check_command_allows_tool_only_smoke() -> None:
    ...
    assert "import codex_tools" in command
