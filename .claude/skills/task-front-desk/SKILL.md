...
description: Legacy fallback for manually driving old task-local front_door_bell.py
  scripts when harness hooks are unavailable and the user explicitly asks for the
  fallback protocol.
---
