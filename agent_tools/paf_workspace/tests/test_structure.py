...
from paf_workspace.structure import assert_agent_tools_structure
from paf_workspace.structure import assert_paf_workspace_structure


def test_agent_tools_structure() -> None:
    assert_agent_tools_structure(Path(__file__).resolve().parents[2])
...
def test_environment_profiles_match_schema() -> None:
    ...
    environment_domain = agent_tools_root / "paf_workspace" / "domains" / "environments"
