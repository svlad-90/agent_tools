...
from agent_tools.tools.agent_workspace.components.web_frontend.api import create_server
...
def test_agent_workspace_service_and_web_modules_do_not_import_gtk() -> None:
    code = "\n".join(
        [
            "import sys",
            "import agent_tools.tools.agent_workspace.components.workspace_service.api",
            "import agent_tools.tools.agent_workspace.components.web_frontend.api",
