...
def test_agent_workspace_component_api_modules_import_without_gtk() -> None:
    code = "\n".join(
        [
            ...
            "for component in components:",
            "    importlib.import_module(f'agent_tools.tools.agent_workspace.components.{component}.api')",
...
def test_task_catalog_api_import_does_not_import_agent_workspace_core() -> None:
    code = "\n".join(
        [
            "import importlib",
            "import sys",
            "importlib.import_module('agent_tools.tools.agent_workspace.components.task_catalog.api')",
            "assert 'agent_tools.tools.agent_workspace.core' not in sys.modules",
        ]
    )
