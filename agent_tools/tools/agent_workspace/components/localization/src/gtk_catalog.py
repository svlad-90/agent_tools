...
TRANSLATIONS = _load_translation_map("gtk_translation_catalog.json")
UI_STRINGS = _load_translation_map("gtk_ui_catalog.json")
CODEX_LANGUAGE_INSTRUCTIONS = _load_language_instructions("gtk_language_catalog.json")
